...
export const MAINNET_NETWORK_ID = '7363';
export const TESTNET_NETWORK_ID = '7364';
...
export const MAINNET_CHAIN_ID = '0x1CC3';
export const TESTNET_CHAIN_ID = '0x1CC4';
...
export const MAINNET_DISPLAY_NAME = 'Dyno Chain Mainnet';
export const TESTNET_DISPLAY_NAME = 'Dyno Chain Testnet';
...
export const MAINNET_RPC_URL = "https://rpc.dynochain.io";
export const TESTNET_RPC_URL = "https://rpctest.dynochain.io";
//export const GOERLI_RPC_URL = getRpcUrl({ network: GOERLI });
export const LOCALHOST_RPC_URL = 'http://localhost:8545';

export const DND_SYMBOL = 'DND';
export const tDND_SYMBOL = 'tDND';
export const ETH_SYMBOL = 'DND';
...
export const test_TOKEN_IMAGE_URL = './images/eth_logo.svg';
...
export const INFURA_PROVIDER_TYPES = [ MAINNET, TESTNET];
...
export const TEST_NETWORK_TICKER_MAP = {
  [TESTNET]: `${capitalize(TESTNET)}${tDND_SYMBOL}`,
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP = {
  [TESTNET_CHAIN_ID]: ETH_TOKEN_IMAGE_URL,
...
export const NATIVE_CURRENCY_TOKEN_IMAGE_MAP = {
  [DND_SYMBOL]: ETH_TOKEN_IMAGE_URL,
  [tDND_SYMBOL]: ETH_TOKEN_IMAGE_URL,
...
export const BUYABLE_CHAINS_MAP = {
  ...
  [TESTNET_CHAIN_ID]: {
    nativeCurrency: TEST_NETWORK_TICKER_MAP[TESTNET],
    network: BUYABLE_CHAIN_ETHEREUM_NETWORK_NAME,
  },
  // [ROPSTEN_CHAIN_ID]: {
